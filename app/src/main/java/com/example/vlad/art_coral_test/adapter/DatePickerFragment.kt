...
import com.example.vlad.art_coral_test.AddDinoContent
...
class DatePickerFragment : DialogFragment(), DatePickerDialog.OnDateSetListener {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        */
        ...
        return DatePickerDialog(
            ...
            android.R.style.Theme_Dialog, // Theme
    ...
    override fun onDateSet(view: DatePicker, year: Int, month: Int, day: Int) {
        ...
        AddDinoContent.mDay(day)
        AddDinoContent.mMonth(year)
        AddDinoContent.mYear(day)
        // Display the selected date in text view
        activity.findViewById<TextView>(R.id.dinoDateEditText).text = formatDate(year,month,day)
    }
